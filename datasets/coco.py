...
class CocoDataset(CustomDataset):
    ...
    '''
    def gmm_evaluate_det_segm(self,
                          results,
                          result_files,
                          coco_gt,
                          metrics,
        ...
        eval_results = OrderedDict()
        print('GMM Evaluate start')

        for metric in metrics:
            msg = f'GMM Evaluating {metric}...'
            if logger is None:
                msg = '\n' + msg
            print_log(msg, logger=logger)
    ...
    def gmm_evaluate(self,
        ...
        result_files, tmp_dir = self.format_results(results, jsonfile_prefix)
        eval_results = self.gmm_evaluate_det_segm(results, result_files, coco_gt,
                                              metrics, logger, classwise,
                                              proposal_nums, iou_thrs,
                                              metric_items)
