...
from mmdet.core import DistEvalHook, EvalHook, GMMDistEvalHook, GMMEvalHook, build_optimizer
...
def train_detector(model,
    ...
    runner.register_training_hooks(
        ...
        custom_hooks_config=cfg.get('custom_hooks', None))  # custom_hooks에 momentum 넣으면 됨!
    ...
    if validate:
        ...
        gmm_eval_hook = GMMDistEvalHook if distributed else GMMEvalHook
    ...
    runner.run(data_loaders, cfg.workflow, train_loader_cfg, dataset)
